...
import { BentoCard, BentoGrid, CARDS } from '@/components/ui/bento-gird'
                ...
                <AnimationContainer delay={0.1}>
                    <LampContainer>
                        <div className='flex flex-col items-center justify-center relative w-full text-center'>
                            <h2 className='bg-gradient-to-b from-neutral-200 to-neutral-400 py-4 capitalize bg-clip-text text-center text-4xl md:text-7xl !leading-[1.15] font-medium font-heading tracking-tight text-transparent mt-8'>
                                Step intro the future of link management
                            </h2>
